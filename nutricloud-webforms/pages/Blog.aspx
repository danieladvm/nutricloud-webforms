    ...
    <div class="container">
        ...
        <a href="Nota.aspx" class="collection-item">
            <div class="row">
                ...
                <div class="col l9 m9 s12 note-blog">
                    ...
                    <p class="grey-text">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed euismod varius pretium. 
                        ...
                        Praesent pharetra lectus at condimentum rutrum.</p>
                    <span>Leer Más</span>
                </div>
           </div>
        </a>
        ...
        <a href="Nota.aspx" class="collection-item">
               <div class="row">
                ...
                <div class="col l9 m9 s12 note-blog">
                    <h5>Título Nota Blog</h5>
                    <p class="grey-text darken-1">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed euismod varius pretium. 
                        Curabitur luctus condimentum laoreet. Ut egestas arcu imperdiet hendrerit consequat. Pellentesque convallis commodo blandit. 
                        Praesent pharetra lectus at condimentum rutrum.</p>
                    <span>Leer Más</span>
                </div>
